...
\begin{compactenum}
  ...
  \item arithmetic operations (e.g. +, *, sum, min),
...
\end{compactenum}
In our case, the '$\vee$', '$\wedge$', 'alldifferent.mzn' from 'globals.mzn', 'set of int' and some functions have been used (more details in Chapter 4).
