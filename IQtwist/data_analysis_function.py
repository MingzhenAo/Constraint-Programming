...
def get_solvedcases_coverage_and_averagetime(difficulty):
    ...
    for solver in solvers:
      ...
      while n<25:
        ...
        n+=1
    print("The number of solved cases for choco in "+difficulty+": "+str(cal_solved_case(IQ_twist_choco)))
    print("The number of solved cases for chuffed in "+difficulty+": "+str(cal_solved_case(IQ_twist_chuffed)))
    print("The number of solved cases for coinbc in "+difficulty+": "+str(cal_solved_case(IQ_twist_coinbc)))
    print("The number of solved cases for gurobi in "+difficulty+": "+str(cal_solved_case(IQ_twist_gurobi)))
    print("The number of solved cases for izplus in "+difficulty+": "+str(cal_solved_case(IQ_twist_izplus)))
    print("The number of solved cases for jacop in "+difficulty+": "+str(cal_solved_case(IQ_twist_jacop)))
    print("The number of solved cases for ortool in "+difficulty+": "+str(cal_solved_case(IQ_twist_ortool)))
    print("The number of solved cases for picat in "+difficulty+": "+str(cal_solved_case(IQ_twist_picat)))
    print("The number of solved cases for yuck in "+difficulty+": "+str(cal_solved_case(IQ_twist_yuck)))
    print("Coverage of choco in "+difficulty+": "+str(get_coverage(IQ_twist_choco)))
    print("Coverage of chuffed in "+difficulty+": "+str(get_coverage(IQ_twist_chuffed)))
    print("Coverage of coinbc in "+difficulty+": "+str(get_coverage(IQ_twist_coinbc)))
    print("Coverage of gurobi in "+difficulty+": "+str(get_coverage(IQ_twist_gurobi)))
    print("Coverage of izplus in "+difficulty+": "+str(get_coverage(IQ_twist_izplus)))
    print("Coverage of jacop in "+difficulty+": "+str(get_coverage(IQ_twist_jacop)))
           ...
           while n<25:
             with open(difficulty+'/model'+str(n)+'/'+'model' + str(n) + solver+'.log','r') as log:
                 if solver=='choco':
                    ...
                    solver_get_time(log,IQ_twist_yuck)
             n+=1
    print("The overall number of solved cases for choco:"+str(cal_solved_case(IQ_twist_choco)))
    print("The overall number of solved cases for chuffed:"+str(cal_solved_case(IQ_twist_chuffed)))
    print("The overall number of solved cases for coinbc:"+str(cal_solved_case(IQ_twist_coinbc)))
    print("The overall number of solved cases for gurobi:"+str(cal_solved_case(IQ_twist_gurobi)))
    print("The overall number of solved cases for izplus:"+str(cal_solved_case(IQ_twist_izplus)))
    print("The overall number of solved cases for jacop:"+str(cal_solved_case(IQ_twist_jacop)))
    print("The overall number of solved cases for ortool:"+str(cal_solved_case(IQ_twist_ortool)))
    print("The overall number of solved cases for picat:"+str(cal_solved_case(IQ_twist_picat)))
    print("The overall number of solved cases for yuck:"+str(cal_solved_case(IQ_twist_yuck)))
