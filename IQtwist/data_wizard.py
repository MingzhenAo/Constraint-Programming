...
print('  ')
print('   ')
print("average time of chocho:"+str(average_time(wizard_IQtwist_choco)))
print("average time of chuffed:"+str(average_time(wizard_IQtwist_chuffed)))
print("average time of coinbc:"+str(average_time(wizard_IQtwist_coinbc)))
print("average time of gurobi:"+str(average_time(wizard_IQtwist_gurobi)))
print("average time of izplus:"+str(average_time(wizard_IQtwist_izplus)))
print("average time of jacop:"+str(average_time(wizard_IQtwist_jacop)))
print("average time of ortool:"+str(average_time(wizard_IQtwist_ortool)))
print("average time of picat:"+str(average_time(wizard_IQtwist_picat)))
print("average time of yuck:"+str(average_time(wizard_IQtwist_yuck)))