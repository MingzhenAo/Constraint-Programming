...
wizard=[[               (),                   (),                   (),               (),           (),(141,151,241),(312,313,412),               (),(211,111,121,212)],
...
def create_models(difficulty,difficulty_data):
    ...
    while n<9:
        ...
        with open('playingmode1/'+difficulty+'/model'+str(n)+'/'+name,"w") as f1:
            for line in f:
                f1.write(line);
            m=0
            while m<len(element):
                ...
                if len(element[m])!=0:
                   ...
                   for line in f:
                          f1.write(line);
                m+=1
        os.system("minizinc.exe -c --solver org.minizinc.mzn-fzn"+'  playingmode1/'+difficulty+'/model'+str(n)+'/'+name+" --sac" )
        n+=1
'''
