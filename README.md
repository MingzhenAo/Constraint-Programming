...
The "timeout 1800" is used to set the time limit as 1800 seconds. The "--output-time" is used to print the runtime. And the "--sac" aims to achieve singleton arc consistency for the model. Comparably, other models and solvers are executed by the same way.
