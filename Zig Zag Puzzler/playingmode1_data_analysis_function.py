...
def get_solvedcases_coverage_and_averagetime(difficulty):
    ...
    print(
        ...
        + difficulty
        + ": "
        + str(cal_solved_case(ZigZag_Playingmode1_choco))
    )
    print(
        "The number of solved cases for chuffed in "
        + difficulty
        + ": "
        + str(cal_solved_case(ZigZag_Playingmode1_chuffed))
    )
    print(
        "The number of solved cases for coinbc in "
        + difficulty
        + ": "
        + str(cal_solved_case(ZigZag_Playingmode1_coinbc))
    )
    print(
        "The number of solved cases for gurobi in "
        + difficulty
        + ": "
        + str(cal_solved_case(ZigZag_Playingmode1_gurobi))
    )
    print(
        "The number of solved cases for izplus in "
        + difficulty
        + ": "
        + str(cal_solved_case(ZigZag_Playingmode1_izplus))
    )
    print(
        "The number of solved cases for jacop in "
        + difficulty
        + ": "
        + str(cal_solved_case(ZigZag_Playingmode1_jacop))
    )
    print(
        "The number of solved cases for ortool in "
        + difficulty
        + ": "
        + str(cal_solved_case(ZigZag_Playingmode1_ortool))
    )
    print(
        "The number of solved cases for picat in "
        + difficulty
        + ": "
        + str(cal_solved_case(ZigZag_Playingmode1_picat))
    )
    print(
        "The number of solved cases for yuck in "
        + difficulty
        + ": "
        + str(cal_solved_case(ZigZag_Playingmode1_yuck))
    )
    print(
        "Coverage of choco in "
        + difficulty
        + ": "
        + str(get_coverage(ZigZag_Playingmode1_choco))
    )
    print(
        "Coverage of chuffed in "
        + difficulty
        + ": "
        + str(get_coverage(ZigZag_Playingmode1_chuffed))
    )
    print(
        "Coverage of coinbc in "
        + difficulty
        + ": "
        + str(get_coverage(ZigZag_Playingmode1_coinbc))
    )
    print(
        "Coverage of gurobi in "
        + difficulty
        + ": "
        + str(get_coverage(ZigZag_Playingmode1_gurobi))
    )
    print(
        "Coverage of izplus in "
        + difficulty
        + ": "
        + str(get_coverage(ZigZag_Playingmode1_izplus))
    )
    print(
        "Coverage of jacop in "
        + difficulty
        + ": "
        + str(get_coverage(ZigZag_Playingmode1_jacop))
    )
    print(
        "Coverage of ortool in "
        + difficulty
        + ": "
        + str(get_coverage(ZigZag_Playingmode1_ortool))
    )
    print(
        "Coverage of picat in "
        + difficulty
        + ": "
        + str(get_coverage(ZigZag_Playingmode1_picat))
    )
    print(
        "Coverage of yuck in "
        + difficulty
        + ": "
        + str(get_coverage(ZigZag_Playingmode1_yuck))
    )
...
def get_overall_solvedcases_coverage_and_averagetime():
    ...
    print(
        "Overall coverage of chuffed:" + str(get_coverage(ZigZag_Playingmode1_chuffed))
    )
